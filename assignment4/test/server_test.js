...
describe('server', function() {
  it('should return OK status on localhost homepage', function(done) {
    chai.request('localhost:8888').get('/time').end(function(err, response)
     {
  ...
  it('check to see if unexpected pathname gets 404 status code', function(done) {
    chai.request('localhost:8888').get('/greett/jon').end(function(err, response)
     {
  ...
  it('check to see if greet/name returns a string', function(done) {
    chai.request('localhost:8888').get('/greet/jon').end(function(err, response)
     {
